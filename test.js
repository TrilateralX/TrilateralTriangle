...
trilateral3_drawing_Sketch.prototype = {
	tracerLine: function(x_,y_) {
		haxe_Log.trace("lineTo( " + this.x + ", " + this.y + ", " + x_ + ", " + y_ + ", width )",{ fileName : "trilateral3/drawing/Sketch.hx", lineNumber : 30, className : "trilateral3.drawing.Sketch", methodName : "tracerLine"});
	}
...
trilateral3_nodule_PenNodule.prototype = {
	...
	,get_size: function() {
		return dsHelper_flatInterleave_core_Flat32.get_size(this.colorTriangles) * 3 | 0;
	}
};
